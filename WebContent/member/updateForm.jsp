...
<body>
	...
	<div class="container" id="insertContainer">
        <form method="post" name="userForm" action="${ctxpath}/member/updatePro.do" onSubmit="return checkMem();">
            ...
            <div class="cansel">
            	<input class="btn btn-primary" type="button" value="취소" onClick="onClick=location.href='${ctxpath}/member/myPageForm.do'">
            </div>
